...
LABEL version="1.0.0"
LABEL permissions='{"ExposedPorts":{"9001/tcp":{}},"HostConfig":{"Privileged":true,"Binds":["/dev:/dev","/root/.config:/root/.config"],"ExtraHosts":["host.docker.internal:host-gateway"],"PortBindings":{"9001/tcp":[{"HostPort":""}]}}}'
